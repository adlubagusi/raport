...
class backup_data extends config {
	...
	public function generate_backup_data() {
		...
		$structureNData = "--".PHP_EOL."-- MANPORT Backup Database".PHP_EOL."-- Author : Admin".PHP_EOL."-- Version : 1.3".PHP_EOL."--".PHP_EOL."-- Host : ".$_SERVER['HTTP_HOST'].PHP_EOL."-- Generation Time : ".date('M d, Y')." at ".date('h:i A').PHP_EOL."-- Server Version : ".$serVersion.PHP_EOL."-- PHP Version : ".phpversion().PHP_EOL.PHP_EOL."--".PHP_EOL."-- Database : `".$this->dbname."`".PHP_EOL."--".PHP_EOL;
